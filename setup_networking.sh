...
# 2. Obtener y Validar Security Group
...
# 3. Obtener y Validar Instancias EC2
...
# Listener HTTP:80 con filtro seguro
...
# 8. API Gateway e Integración Idempotente
